...
function inicio() {
    ...
    vuelos.addEventListener("change",cambioMeter,false);
}

function cambioMeter() {
    var arrayMeter = document.querySelectorAll("meter");
    arrayMeter[vuelos.selecterIndex].value += 5;
...
function coste_hotel() {
    ...
    switch (estrellas.value) {
        case estrellas.value = "1":
            precio = parseInt(noches.value) * 30 * 0.98;
            break;
        case estrellas.value = "2":
            precio = parseInt(noches.value) * 60 * 0.98;
            break;
        case estrellas.value = "3":
            precio = parseInt(noches.value) * 90 * 0.98;
            break;
        case estrellas.value = "4":
            precio = parseInt(noches.value) * 120 * 0.98;
            break;
        case estrellas.value = "5":
            precio = parseInt(noches.value) * 150 * 0.98;
            break;
        default:
